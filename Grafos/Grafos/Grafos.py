...
for i in range(0, Adj.shape[0]):
    ...
    if(i==Adj.shape[0]-1): print()
print('\nTodos los caminos cortos desde el nodo fuente', S,'usando Dijkstra:')
for key in path:
    print('Camino hacia',key)
    print(path[key])
